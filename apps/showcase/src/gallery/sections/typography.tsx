...
const typeWrapStyle = { width: 400 } as const
...
export const typographySection: Section = {
  ...
  pairs: [
    ...
    },
    {
      ...
      shadcn: (
        <div style={typeWrapStyle}>
          <h2 className="text-3xl font-semibold tracking-tight">The People of the Kingdom</h2>
        </div>
      ),
      mui: (
        <div style={typeWrapStyle}>
          <MuiTypography variant="h2">The People of the Kingdom</MuiTypography>
        </div>
      ),
    },
    {
