  ...
  pairs: [
    {
      ...
      ref: <ShadcnToastDemo pairId={PAIR_ID} />,
      mui: <MuiSnackbarDemo />,
    },
    {
      id: ACTION_PAIR_ID,
      states: ["open"],
      ref: <ShadcnToastDemo pairId={ACTION_PAIR_ID} action />,
    ...
    },
    {
      ...
      states: ["open"],
      ref: <ShadcnToastDemo pairId={DESCRIPTION_PAIR_ID} description />,
    ...
    },
    {
      ...
      id: CANCEL_PAIR_ID,
      states: ["open"],
      ref: <ShadcnToastDemo pairId={CANCEL_PAIR_ID} cancel />,
